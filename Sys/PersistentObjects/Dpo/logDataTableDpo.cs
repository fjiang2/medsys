...
#pragma warning disable
        ...
        [Column(_log_table_id, SqlDbType.Int, Identity = true, Primary = true)]                   public int log_table_id;      //int(4) not null
        [Column(_log_dataset_id, SqlDbType.Int)]                                                  public int log_dataset_id;    //int(4) not null
        ...
        [Column(_operation, SqlDbType.Int)]                                                       public int operation;         //int(4) not null
        [Column(_action, SqlDbType.VarChar, Nullable = true, Length = 10)]                        public string action;         //varchar(10) null
        [Column(_value_from, SqlDbType.NText, Nullable = true)]                                   public string value_from;     //ntext(16) null
        [Column(_value_to, SqlDbType.NText, Nullable = true)]                                     public string value_to;       //ntext(16) null
