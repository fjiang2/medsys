...
#pragma warning disable
        ...
        [Column(_Ty, CType.Int, Nullable = true)]                                             public int? Ty {get; set;}    //int(4) null
        [Column(_Key_Name, CType.NVarChar, Primary = true, Length = 128)]                     public string Key_Name {get; set;} //nvarchar(128) not null
        [Column(_Value, CType.NText, Nullable = true)]                                        public string Value {get; set;} //ntext(16) null
