...
#pragma warning disable
        ...
        [Column(_DataSource, CType.NVarChar, Nullable = true, Length = -1)]                   public string DataSource {get; set;} //nvarchar(-1) null
        [Column(_ClassName, CType.NVarChar, Nullable = true, Length = 256)]                   public string ClassName {get; set;} //nvarchar(256) null
        [Column(_Mapping, CType.NText, Nullable = true)]                                      public string Mapping {get; set;} //ntext(16) null
        [Column(_ActionButtonName, CType.NVarChar, Nullable = true, Length = 256)]            public string ActionButtonName {get; set;} //nvarchar(256) null
