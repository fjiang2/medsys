    ...
    public partial class AppLinkMaintenance : BaseForm
    {
        ...
        private void toolStripButtonCreate_Click(object sender, EventArgs e)
        {
            ...
            if (bind.ConfirmAndSave())
                this.ShowMessageBox(Message.Information("Application Link is created."));
        }
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            LookUp lookup = new LookUp("Select Application", DataExtension.FillDataTable <AppLinkDpo>(SQL));
