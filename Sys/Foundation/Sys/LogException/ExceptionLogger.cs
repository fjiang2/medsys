/**code from : http://www.doogal.co.uk/exception.php
 * 
...
namespace Sys
{
    ...
    public class ExceptionLogger
    {
        ...
        private void HandleException(Exception e)
        {
            switch (notificationType)
            {
                ...
                case NotificationType.Inform:
                    MessageBox.Show(e.Message, "Unexpected Error for developer", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    break;
        ...
        public void LogException(Exception exception)
        {
            ...
            error.AppendLine("Version:           " + Sys.SysInformation.ApplicationVerisonText); //Application.ProductVersion);
            error.AppendLine("Date:              " + DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss"));
            error.AppendLine("App user id:       " + Account.CurrentUser.UserName);
            error.AppendLine("App user name:     " + Account.CurrentUser.Name);
            error.AppendLine("Computer name:     " + SystemInformation.ComputerName);
            error.AppendLine("User domain name:  " + SystemInformation.UserDomainName);
